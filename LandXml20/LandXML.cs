...
namespace XmlSchemaProcessor.LandXml20
{
    ...
    public class LandXML : XsdBaseReader
    {
        ...
        protected override Tuple<string, object> NewReader(string namespaceURI, string name)
        {
            ...
            {
                return Tuple.Create("SymbolTable", this.NewReader<SymbolTable>());
            }
            if (name.EqualsIgnoreCase("TextureImageTable"))
            {
                return Tuple.Create("TextureImageTable", this.NewReader<TextureImageTable>());
            }
            if (name.EqualsIgnoreCase("DesignCrossSectionTemplateTable"))
            {
                return Tuple.Create("DesignCrossSectionTemplateTable", this.NewReader<DesignCrossSectionTemplateTable>());
            }
            if (name.EqualsIgnoreCase("MaterialTable"))
            {
                return Tuple.Create("MaterialTable", this.NewReader<MaterialTable>());
            }
