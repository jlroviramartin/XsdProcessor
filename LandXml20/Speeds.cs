...
namespace XmlSchemaProcessor.LandXml20
{
    ...
    public class Speeds : XsdBaseReader
    {
        ...
        protected override bool NewReader(string namespaceURI, string name)
        {
            ...
            {
                this.SetCurrent("PostedSpeed", this.NewReader<PostedSpeed>());
                return true;
            }
            if (name.EqualsIgnoreCase("DesignSpeed85th"))
            {
                this.SetCurrent("DesignSpeed85th", this.NewReader<DesignSpeed85th>());
                return true;
            }
            if (name.EqualsIgnoreCase("DesignSpeed"))
            {
                this.SetCurrent("DesignSpeed", this.NewReader<DesignSpeed>());
                return true;
            }
