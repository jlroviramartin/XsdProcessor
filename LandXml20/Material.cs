...
namespace XmlSchemaProcessor.LandXml20
{
    ...
    public class Material : XsdBaseObject
    {
        ...
        public override string ToAttributes()
        {
            ...
            if ((object)this.LayerName != null)
            {
                buff.AppendFormat(" layerName=\"{0}\"", this.LayerName);
            }
            if ((object)this.Desc != null)
            {
            ...
            if ((object)this.Color != null)
            {
                buff.AppendFormat(" color=\"{0}\"", this.Color);
            }
            if ((object)this.LineType != null)
            {
                buff.AppendFormat(" lineType=\"{0}\"", this.LineType);
            }
            if ((object)this.TextureImageRef != null)
            {
                buff.AppendFormat(" textureImageRef=\"{0}\"", this.TextureImageRef);
            }
            if ((object)this.TextureImageScale != null)
            {
                buff.AppendFormat(" textureImageScale=\"{0}\"", this.TextureImageScale);
            }
            if ((object)this.SymbolXScale != null)
            {
                buff.AppendFormat(" symbolXScale=\"{0}\"", this.SymbolXScale);
            }
            if ((object)this.SymbolYScale != null)
            {
                buff.AppendFormat(" symbolYScale=\"{0}\"", this.SymbolYScale);
            }
            if ((object)this.SymbolZScale != null)
            {
                buff.AppendFormat(" symbolZScale=\"{0}\"", this.SymbolZScale);
            }
            if ((object)this.SymbolRotation != null)
            {
                buff.AppendFormat(" symbolRotation=\"{0}\"", this.SymbolRotation);
            }
            if ((object)this.SymbolRef != null)
            {
                buff.AppendFormat(" symbolRef=\"{0}\"", this.SymbolRef);
            }
