...
namespace XmlSchemaProcessor.LandXml20
{
    ...
    public class TestLandXmlEvents : ILandXmlEvents
    {
        ...
        public virtual void BeginReadTextureHexString( byte[] value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<TextureHexString {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSymbolHexString( byte[] value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<SymbolHexString {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSymbolMtlHexString( byte[] value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<SymbolMtlHexString {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadTextureImageNameRef( string value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<TextureImageNameRef {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadStation( double value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Station {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadFeatureDictionary( FeatureDictionary value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<FeatureDictionary {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadCrossSectPnt( CrossSectPnt value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<CrossSectPnt {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadDesignCrossSectionTemplateTable( DesignCrossSectionTemplateTable value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<DesignCrossSectionTemplateTable {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadDesignCrossSectionTemplate( DesignCrossSectionTemplate value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<DesignCrossSectionTemplate {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadDesignCrossSectSurf( DesignCrossSectSurf value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<DesignCrossSectSurf {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadHeadOfPower( HeadOfPower value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<HeadOfPower {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAdministrativeArea( AdministrativeArea value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AdministrativeArea {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAdministrativeDate( AdministrativeDate value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AdministrativeDate {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAnnotation( Annotation value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Annotation {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSurveyorCertificate( SurveyorCertificate value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<SurveyorCertificate {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadPurposeOfSurvey( PurposeOfSurvey value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<PurposeOfSurvey {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAmendment( Amendment value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Amendment {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAmendmentItem( AmendmentItem value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AmendmentItem {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadTestObservation( TestObservation value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<TestObservation {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadRedHorizontalPosition( RedHorizontalPosition value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<RedHorizontalPosition {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadRedVerticalObservation( RedVerticalObservation value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<RedVerticalObservation {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadTextureImage( TextureImage value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<TextureImage {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSymbol( Symbol value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Symbol {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadMaterial( Material value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Material {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadMaterialTable( MaterialTable value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<MaterialTable {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadTextureImageTable( TextureImageTable value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<TextureImageTable {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSymbolTable( SymbolTable value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<SymbolTable {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadVolumeGeom( VolumeGeom value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<VolumeGeom {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadExclusions( Exclusions value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Exclusions {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadLocationAddress( LocationAddress value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<LocationAddress {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadComplexName( ComplexName value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<ComplexName {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadRoadName( RoadName value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<RoadName {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAddressPoint( AddressPoint value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AddressPoint {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadEggPipe( EggPipe value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<EggPipe {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadPond( Pond value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Pond {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadInSpiral( InSpiral value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<InSpiral {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadCurve1( Curve1 value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Curve1 {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadConnSpiral( ConnSpiral value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<ConnSpiral {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadCurve2( Curve2 value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Curve2 {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadOutSpiral( OutSpiral value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<OutSpiral {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAlignPI( AlignPI value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AlignPI {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadAlignPIs( AlignPIs value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<AlignPIs {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadCant( Cant value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<Cant {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadCantStation( CantStation value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<CantStation {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
        ...
        public virtual void BeginReadSpeedStation( SpeedStation value )
        {
            ...
            if (this.AsXml)
            {
                buff.WriteLine("<SpeedStation {0}>", ToAttributes(value));
                buff.Indent();
            }
            else
            {
