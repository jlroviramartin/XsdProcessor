...
namespace XmlSchemaProcessor.LandXml20
{
	...
	public class PointType : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			...
			this.m = XsdConverter.Instance.Convert<IList<int?>>(attributes.GetSafe("m"));
	...
	public class DesignCrossSectionTemplate : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			base.Read(attributes, text);
			this.name = XsdConverter.Instance.Convert<string>(attributes.GetSafe("name"));
			this.index = XsdConverter.Instance.Convert<int>(attributes.GetSafe("index"));
			this.desc = XsdConverter.Instance.Convert<string>(attributes.GetSafe("desc"));
			this.state = XsdConverter.Instance.Convert<StateType?>(attributes.GetSafe("state"));
			return true;
		}
	...
	public class DesignCrossSectSurf : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			...
			this.m = XsdConverter.Instance.Convert<IList<int?>>(attributes.GetSafe("m"));
			this.designCrossSectionTemplateTableIndex = XsdConverter.Instance.Convert<IList<int?>>(attributes.GetSafe("DesignCrossSectionTemplateTableIndex"));
			return true;
		}
		public override string ToString()
		{
	...
	public class Symbol : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			base.Read(attributes, text);
			this.name = XsdConverter.Instance.Convert<string>(attributes.GetSafe("name"));
			this.type = XsdConverter.Instance.Convert<SymbolType>(attributes.GetSafe("type"));
			return true;
		}
		public override string ToString()
		{
	...
	public class Material : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			...
			this.name = XsdConverter.Instance.Convert<string>(attributes.GetSafe("name"));
			this.index = XsdConverter.Instance.Convert<int>(attributes.GetSafe("index"));
			this.layerName = XsdConverter.Instance.Convert<string>(attributes.GetSafe("layerName"));
			this.desc = XsdConverter.Instance.Convert<string>(attributes.GetSafe("desc"));
			this.color = XsdConverter.Instance.Convert<string>(attributes.GetSafe("color"));
			this.lineType = XsdConverter.Instance.Convert<LineTypes?>(attributes.GetSafe("lineType"));
			this.textureImageRef = XsdConverter.Instance.Convert<string>(attributes.GetSafe("textureImageRef"));
			this.textureImageScale = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("textureImageScale"));
			this.symbolXScale = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("symbolXScale"));
			this.symbolYScale = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("symbolYScale"));
			this.symbolZScale = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("symbolZScale"));
			this.symbolRotation = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("symbolRotation"));
			this.symbolRef = XsdConverter.Instance.Convert<string>(attributes.GetSafe("symbolRef"));
			return true;
		}
		public override string ToString()
		{
	...
	public class Boundary : XsdBaseObject
	{
		public override bool Read(IDictionary<string, string> attributes, string text)
		{
			...
			this.name = XsdConverter.Instance.Convert<string>(attributes.GetSafe("name"));
			this.state = XsdConverter.Instance.Convert<StateType?>(attributes.GetSafe("state"));
			this.coefficient = XsdConverter.Instance.Convert<double?>(attributes.GetSafe("coefficient"));
			this.cn = XsdConverter.Instance.Convert<int?>(attributes.GetSafe("cn"));
			this.m = XsdConverter.Instance.Convert<IList<int?>>(attributes.GetSafe("m"));
			return true;
		}
		public override string ToString()
	...
	public class TestLandXmlEvents : ILandXmlEvents
	{
		...
		public virtual void BeginReadTextureHexString( byte[] value )
		{
			...
			{
				buff.WriteLine("BeginReadTextureHexString");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadTextureHexString()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadTextureHexString");
			}
		}
		public virtual void BeginReadSymbolHexString( byte[] value )
		{
			...
			{
				buff.WriteLine("BeginReadSymbolHexString");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadSymbolHexString()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadSymbolHexString");
			}
		}
		public virtual void BeginReadSymbolMtlHexString( byte[] value )
		{
			...
			{
				buff.WriteLine("BeginReadSymbolMtlHexString");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadSymbolMtlHexString()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadSymbolMtlHexString");
			}
		}
		public virtual void BeginReadTextureImageNameRef( string value )
		{
			...
			{
				buff.WriteLine("BeginReadTextureImageNameRef");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadTextureImageNameRef()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadTextureImageNameRef");
			}
		}
		public virtual void BeginReadBeginRunoutSta( double value )
		{
		...
		public virtual void BeginReadDesignCrossSectionTemplateTable( DesignCrossSectionTemplateTable value )
		{
			...
			{
				buff.WriteLine("BeginReadDesignCrossSectionTemplateTable");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadDesignCrossSectionTemplateTable()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadDesignCrossSectionTemplateTable");
			}
		}
		public virtual void BeginReadDesignCrossSectionTemplate( DesignCrossSectionTemplate value )
		{
			...
			{
				buff.WriteLine("BeginReadDesignCrossSectionTemplate");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadDesignCrossSectionTemplate()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadDesignCrossSectionTemplate");
			}
		}
		public virtual void BeginReadDesignCrossSectSurf( DesignCrossSectSurf value )
		{
		...
		public virtual void BeginReadTextureImage( TextureImage value )
		{
			...
			{
				buff.WriteLine("BeginReadTextureImage");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadTextureImage()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadTextureImage");
			}
		}
		public virtual void BeginReadSymbol( Symbol value )
		{
			...
			{
				buff.WriteLine("BeginReadSymbol");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void BeginReadMaterial( Material value )
		{
			...
			{
				buff.WriteLine("BeginReadMaterial");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadMaterial()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadMaterial");
			}
		}
		public virtual void BeginReadMaterialTable( MaterialTable value )
		{
			...
			{
				buff.WriteLine("BeginReadMaterialTable");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadMaterialTable()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadMaterialTable");
			}
		}
		public virtual void BeginReadTextureImageTable( TextureImageTable value )
		{
			...
			{
				buff.WriteLine("BeginReadTextureImageTable");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadTextureImageTable()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadTextureImageTable");
			}
		}
		public virtual void BeginReadSymbolTable( SymbolTable value )
		{
			...
			{
				buff.WriteLine("BeginReadSymbolTable");
				buff.Indent();
				buff.WriteLine(value);
				buff.Indent();
			}
		...
		public virtual void EndReadSymbolTable()
		{
			...
			else
			{
				buff.Unindent();
				buff.Unindent();
				buff.WriteLine("EndReadSymbolTable");
			}
		}
		public virtual void BeginReadSurfaces( Surfaces value )
		{
	...
	public class LandXmlReader : SimpleReader
	{
			...
			: base("http://www.landxml.org/schema/LandXML-2.0", "http://www.landxml.org/schema/LandXML-1.2", "http://www.landxml.org/schema/LandXML-1.1", "http://www.landxml.org/schema/LandXML-1.0")
		{
			...
			this.Register<byte[]>("TextureHexString", events.BeginReadTextureHexString, events.EndReadTextureHexString, true);
			this.Register<byte[]>("SymbolHexString", events.BeginReadSymbolHexString, events.EndReadSymbolHexString, true);
			this.Register<byte[]>("SymbolMtlHexString", events.BeginReadSymbolMtlHexString, events.EndReadSymbolMtlHexString, true);
			this.Register<string>("TextureImageNameRef", events.BeginReadTextureImageNameRef, events.EndReadTextureImageNameRef, true);
			...
			this.Register<DesignCrossSectionTemplateTable>("DesignCrossSectionTemplateTable", events.BeginReadDesignCrossSectionTemplateTable, events.EndReadDesignCrossSectionTemplateTable, false);
			this.Register<DesignCrossSectionTemplate>("DesignCrossSectionTemplate", events.BeginReadDesignCrossSectionTemplate, events.EndReadDesignCrossSectionTemplate, false);
			...
			this.Register<TextureImage>("TextureImage", events.BeginReadTextureImage, events.EndReadTextureImage, false);
			this.Register<Symbol>("Symbol", events.BeginReadSymbol, events.EndReadSymbol, false);
			this.Register<Material>("Material", events.BeginReadMaterial, events.EndReadMaterial, false);
			this.Register<MaterialTable>("MaterialTable", events.BeginReadMaterialTable, events.EndReadMaterialTable, false);
			this.Register<TextureImageTable>("TextureImageTable", events.BeginReadTextureImageTable, events.EndReadTextureImageTable, false);
			this.Register<SymbolTable>("SymbolTable", events.BeginReadSymbolTable, events.EndReadSymbolTable, false);
			...
			this.Register<Pond>("Pond", events.BeginReadPond, events.EndReadPond, false);
