...
namespace XmlSchemaProcessor.LandXml11
{
	...
	public class PointType : XsdBaseObject
	{
	    ...
	    public override string ToString()
	    {
	        ...
	        buff.Append("ellipsoidElev = ").AppendLine(this.ellipsoidElev);
	...
	public class SurveyHeader : XsdBaseObject
	{
	    public override bool Read(IDictionary<string, string> attributes, string text)
	    {
	        ...
	        this.headOfPower = XsdConverter.Instance.Convert<string>(
	                attributes.GetSafe("headOfPower"));
	    ...
	    public override string ToString()
	    {
	        ...
	        buff.Append("headOfPower = ").AppendLine(this.headOfPower);
	...
	public interface ILandXmlEvents
	{
	    ...
	    ///      Attribute headOfPower of type headOfPowerType
	...
	public class LandXmlReader : SimpleReader
	{
	    public LandXmlReader(ILandXmlEvents events)
	        : base("http://www.landxml.org/schema/LandXML-1.1", "http://www.landxml.org/schema/LandXML-1.0")
	    {
